...
export function ChallengeGridItem({
  ...
  return (
    <a href={`/challenges/${challenge.id}`} className='block h-full group'>
      <Card className='flex h-full flex-col overflow-hidden rounded-xl border border-border/50 bg-card shadow-md transition-transform gap-0 duration-300 hover:shadow-xl hover:scale-[1.02] py-0'>
        {/* Image Section */}
