      ...
      <section className='py-20 bg-background'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            <h2 className='text-5xl md:text-7xl font-bold text-primary mb-5'>
              How It Works
            </h2>
            ...
            <div className='max-w-4xl mx-auto antialiased pt-4 relative'>
              ...
              >
                <div className='flex justify-center md:justify-start'>
                  <div className='w-full max-w-sm md:max-w-xs lg:max-w-sm md:mr-20 lg:mr-16'>
                      ...
                      <Card className='hover:shadow-md transition-shadow hover:scale-[1.02] hover:border-primary/30 cursor-pointer'>
                        <CardHeader className='text-center px-4 md:px-6'>
                          <div className='flex items-center justify-center mb-4 md:mb-5'>
                            <div className='h-12 w-12 md:h-16 md:w-16 bg-primary rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform'>
              ...
              >
                <div className='flex justify-center md:justify-end'>
                  <div className='w-full max-w-sm md:max-w-xs lg:max-w-sm md:ml-20 lg:ml-16'>
