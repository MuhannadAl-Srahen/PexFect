                ...
                <StaggerItem key={feature.name}>
                  <div className='group h-full'>
                    <Link to={feature.link} className='block h-full'>
                      <Card className='flex h-full flex-col overflow-hidden rounded-xl border border-border/50 bg-card shadow-lg transition-all duration-300 hover:shadow-xl hover:border-primary/40 hover:scale-[1.06]'>
