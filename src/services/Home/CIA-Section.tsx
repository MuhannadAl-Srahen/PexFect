        ...
        <AnimateOnScroll animation='scale' delay={0.3}>
          <div className='flex justify-center mt-12 sm:mt-20'>
            <Button
              asChild
              size='lg'
              className='bg-primary hover:bg-primary/80 text-primary-foreground px-8 py-3 text-base font-semibold rounded-lg shadow-lg hover:shadow-xl hover:scale-[1.06] transition-all duration-300'
            >
              <Link to='/signup'>
                Sign Up for Free
